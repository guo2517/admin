<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"/www/wwwroot/admin/thinkphp/tpl/dispatch_jump.tpl";i:1581044049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <style type="text/css">
        ...
        @media screen and (min-width: 601px) {
            .bi{font-size: 80px;margin-top:calc(25% - 80px);}
           .bg{
                border-radius: 4px;
                width:400px;height: 300px;left:calc(50% - 200px);top:calc(50% - 150px);
            }
            .content{display: block;width: 100%;height:50%;padding:10px 10px;position: absolute;bottom:0px;}
    ...
    <div class="bg">   
        ...
        <div class="content ">
            ...
            <a href="<?php echo strlen($url)>0?$url:'javascript:history.go(-1);';?>" id="jump" class="jump"><div class="title "><?php echo isset($title)?$title:"";?></div>
                ...
                <div class="description warning jumpdesc">等待跳转<span class="wait"><?php echo $wait; ?></span>秒</div>
                <?php }?>
            </a> 
        </div> 
